...
#Human autosomes 7, 8
load('PATH_TO_HUMAN_AUTOSOME_7_SKEW_AND_STATS_DF')
load('PATH_TO_HUMAN_AUTOSOME_8_SKEW_AND_STATS_DF')
```
...
x = load("PATH_TO_HUMAN_CHRX_SKEW_AND_STATS_DF")
...
temp_human_skew_and_stats_df = human_skew_and_stats_df[index, ]
#Filter for samples with at least 10 SNPs on each chromosome
num_snp_index = human_chr7_skew_and_stats_df$num_good_snps >= snp_thresh & temp_human_skew_and_stats_df$num_snps>= snp_thresh
...
human_skew_and_stats_df
save(human_skew_and_stats_df, file = 'PATH_TO_HUMAN_SKEW_AND_STATS_AUTOSOME_FILTERING_DF')
