...
Macaca mulatta annotations dont have XIST? 
Seems like we don't know where the XIST gene is in Macaca
...
star_output = paste("/grid/gillis/home/hover/work/cmxci.paired/Macaca_mulatta.X/", star_output, sep = '')
star_output
```
...
star_output = paste(wig_samples, '.wasp.ReadsPerGene.out.tab', sep = '')
star_output = paste("/grid/gillis/home/hover/work/cmxci.single/Macaca_mulatta.X/", star_output, sep = '')
star_output
```
...
```{r}
test_star_output = read.table(star_output[1], skip = 4)
test_star_output[grepl('XI', test_star_output$V1), ]
...
for(i in 1:length(star_output)){
  ...
  xist_reads[i] = temp_star_mapped_genes$V2[temp_star_mapped_genes$V1 == "SRY"]
}
